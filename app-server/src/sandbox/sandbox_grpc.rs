...
pub mod sandbox_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn run_code(
            &mut self,
            request: impl tonic::IntoRequest<super::RunCodeRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RunCodeResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("sandbox_grpc.Sandbox", "RunCode"));
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sandbox_grpc.Sandbox", "Healthcheck"));
            self.inner.unary(req, path, codec).await
        }
    }
}
